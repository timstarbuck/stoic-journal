...
export const morningTheme: ReflectionTheme = {
  ...
  successBg:
    'bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800/30 text-green-600 dark:text-green-400',
  errorBg:
    'bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800/30 text-red-600 dark:text-red-400',
  loadingBg:
    'bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900',
  loadingSpinner: 'border-b-2 border-slate-900 dark:border-slate-50',
  placeholder:
    'How does this quote resonate with you? What can you learn from it today?',
};
...
export const eveningTheme: ReflectionTheme = {
  ...
  bgGradient:
    'bg-gradient-to-b from-slate-800 to-slate-900 dark:from-slate-950 dark:to-slate-950',
  ...
  textareaClass:
    'min-h-64 bg-slate-700 border-slate-600 text-slate-50 placeholder:text-slate-400',
  ...
  placeholder:
    'How was your day? What did you learn? How can you apply this quote to tomorrow?',
};
